...
export default function DeliveriesCreate({ match, history }) {
	...
	emailjs.sendForm('service_a0dl37h', 'template_nolrmc6', formDelivery.current, '-l-yfdg2kBiYgzEht')
    .then((result)=> {
						...
						<Card.Body>
							...
							<Form onSubmit={submitHandler} ref={formDelivery}>
								...
								<Form.Group controlId="email">
									...
									<Form.Control type="email" value={customerInfo.email} placeholder="Enter  Your Email" name="useremail" readOnly />
								</Form.Group>
								<br></br>
								<Form.Group controlId="email">
